...
<li>- Information if you have databases that Oskari could use</li>
</ul>
</Text>
...
<li>- The possible configurations that have been done to your Oskari service</li>
<li>- A link to the documentation of configurations</li>
</ul>
</Text>
...
<Text>
In other cases a certain functionality is in heavy use and other organisations might have similar wishes to develop it further, but that requires communication between organisations.
</Text>
...
<li>- Updating and maintenance of database connections</li>
</ul>
</Text>
...
<li>- Competence related to Oskari&apos;s front-end and its configurations</li>
</ul>
</Text>
...
<ul>
??? experience:
<li>- Updating Oskari (step-by-step instructions in <Link href='https://github.com/oskariorg/oskari-server/blob/master/MigrationGuide.md'>the migration guide</Link>)</li>
</ul>
</Text>
